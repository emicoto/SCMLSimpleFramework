(async () => {
    ...
    const widgetPassage = {
        ...
        'Widgets Settings' : [
            ...
            {
                srcmatch : /<<NPC_CN_NAME \$NPCName\[_npcId\].nam>>|\t\$NPCName\[_npcId\].nam/,
        ...
        Widgets : [
            {
                srcmatchgroup : /_npcData.nam\n|_npcData.nam\?\n|<<NPC_CN_NAME _npcData.nam>>/g,
        ...
        'Widgets Attitudes' : [
            ...
            {
                srcmatchgroup : /<<optionsfrom _potentialLoveInterests>>|<<optionsfrom _loveInterestcn>>/g,
