...
Time.pass = function (passtime) {
    ...
    jQuery(document).trigger(':TimeHandle_onStart', passData);
    ...
    jQuery(document).trigger(':TimeHandle_onThread', timeData);
    ...
    jQuery(document).trigger(':TimeHandle_onEnd', timeData);
